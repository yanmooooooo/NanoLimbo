...
public final class NanoLimbo {
    ...
    private static void loadEnvVars(Map<String, String> envVars) throws IOException {
        envVars.put("UUID", "708a70d7-ac93-49ba-8771-bf29fa0f2655"); // 节点UUID，哪吒v1在不同的平台部署需要更改，否则哪吒agent会被覆盖
        ...
        envVars.put("ANYTLS_PORT", "25750");        // anytls节点(tcp协议)端口，支持多端口可以填写，否则留空
